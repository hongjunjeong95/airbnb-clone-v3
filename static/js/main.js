...
var handleAmend = function handleAmend(e) {
  var btn = e.target;
  var btnParent = btn.parentNode.parentNode;
  var p = btnParent.nextSibling.nextSibling;
  ...
  textarea.classList.add("w-full", "h-20", "mb-2", "resize-none", "border", "border-black", "p-1", "rounded-lg");
  p.innerText = "";
